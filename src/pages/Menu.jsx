...
function Menu()
{
    return(
        <>
        {/* menu-nav */}
           <div className="flex justify-between items-center max-sm:w-full py-4 px-4 bg-green-100 sm:hidden">
                <div>
                ...
                <div>
                   <h1 className="font-semibold text-xl text-orange-600">Menu</h1>
                </div>
