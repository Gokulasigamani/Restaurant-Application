        ...
        <>
         <div className='max-sm:relative sm:hidden'>
            ...
            <div className='max-sm:max-sm:flex max-sm:justify-center '>
               ...
               <Link  className=' bg-transparent border text-white hover:bg-white hover:text-black shadow-lg shadow-black-700 px-10 py-2 rounded-3xl  font-semibold sm:hidden max-sm:absolute max-sm:top-[265px] border-white ' data-aos="fade-bottom">Book your Table</Link>
