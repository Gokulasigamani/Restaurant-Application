...
function Review()
{
    ...
    return(
        <>  
            ...
            <div className="sm:w-[1100px] max-sm:hidden m-auto mt-[100px]">
               
               <div className=" text-center text-3xl mb-2" data-aos="zoom-in">
                <h1 className="text-orange-600 font-bold text-5xl">Customer <span className="text-black">Reviews</span></h1>
               </div>
...

                 {
                    ...
                    (
                        <div className="bg-orange-400 rounded-xl">
                               ...
                               <div className="bg-orange-100 text-center h-[210px] p-4">
